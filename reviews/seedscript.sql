...
LOAD DATA LOCAL INFILE 'C:\\Users\\Owner\\isaacProxyLayer\\reviews\\fakeRestaurants.csv'
INTO TABLE restaurants
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:\\Users\\Owner\\isaacProxyLayer\\reviews\\fakeusers.csv'
INTO TABLE users
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;

LOAD DATA LOCAL INFILE 'C:\\Users\\Owner\\isaacProxyLayer\\reviews\\fakeReviews.csv'
INTO TABLE reviews
FIELDS TERMINATED BY ',' ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 ROWS;
